  ...
  $document.ready(function () {
    ...
    if ($("[data-bg]").length) {
      $("[data-bg]").each(function () {
        ...
        if (
          $this.hasClass("fullwidth-bg") ||
          $this.hasClass("fullwidth") ||
          $this.hasClass("col-50")
        ) {
          $this.css({
    ...
    if (blocks.mainSlider.length) {
      ...
      $el.on("beforeChange", function (e, slick, currentSlide, nextSlide) {
        ...
        $('div.slide[data-slick-index="' + currentSlide + '"]').addClass(
          "hideMask"
        );
    ...
    if (blocks.testimonialMoreLink.length) {
      var $testimonialMoreLink = blocks.testimonialMoreLink,
        $testimonialPreload = $testimonialMoreLink
          .closest(".container")
  ...
  function isotopeGallery(galleryIsotope, gallerySlick, windowWidth) {
    ...
    if (windowWidth > 767) {
      ...
      if (!$gallerySlick.hasClass("slick-slider")) {
        $gallerySlick.append(
          $galleryIsotope.children().clone().removeAttr("style")
        );
        $("#isotopeGalleryFilters")
          .children()
          .clone()
          .appendTo("#slickGalleryFilters");
        $gallerySlick.slick({
          slidesToShow: 2,
          slidesToScroll: 1,
          infinite: true,
