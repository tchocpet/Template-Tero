			...
			<div class="row">
					...
					<div class="column-filters-inside">
						<div class="side-block">
							...
							<ul class="category-list">
								...
								<li><a href="#">Surface Care & Protection</a></li>
								<li><a href="#">Pet Stain & Odor Remover</a></li>
								<li><a href="#">Carpet & Floor Cleaners</a></li>
								<li><a href="#">Kitchen Cleaners</a></li>
								<li><a href="#">Glass Cleaners</a></li>
								<li><a href="#">Drain & Septic Care</a></li>
							</ul>
						</div>
						<div class="side-block">
							<h3>Price</h3>
						...
						<div class="side-block">
							...
							<div class="prd-sm">
								...
								<div class="prd-sm-info">
									<h3><a href="product.html">Pledge Multi Surface Antibacterial</a></h3>
									<div class="price">$2.11</div>
								</div>
							</div>
							<div class="prd-sm">
								<div class="prd-sm-img">
									<a href="product.html"><img src="images/product/prd-sm-3.jpg" class="img-responsive" alt=""></a>
								</div>
								<div class="prd-sm-info">
									<h3><a href="product.html">Handmaster Medium Utility Stretch</a></h3>
				...
				<div class="col-md-8 col-lg-9">
					...
					<div class="prd-grid">
						...
						<div class="prd">
							<div class="prd-img">
								<a href="product.html"><img src="images/product/prd-4.jpg" class="img-responsive" alt=""></a>
							</div>
							<div class="prd-info">
								<h3><a href="product.html">Ocelo Handy Sponge, 4.7 in. x 2.5 in. x 0.6 in.</a></h3>
								<div class="rating rating-4"><i class="icon-star-black"></i><i class="icon-star-black"></i><i class="icon-star-black"></i><i class="icon-star-black"></i><i class="icon-star-black"></i></div>
								<div class="price">$2.99</div>
								<a href="#" class="btn"><i class="icon-market"></i>Add To Cart</a>
							</div>
						</div>
						<div class="prd">
							<div class="prd-img">
								<a href="product.html"><img src="images/product/prd-5.jpg" class="img-responsive" alt=""></a>
							</div>
							<div class="prd-info">
						...
						<div class="prd">
							...
							<div class="prd-info">
								...
								<div class="rating rating-5"><i class="icon-star-black"></i><i class="icon-star-black"></i><i class="icon-star-black"></i><i class="icon-star-black"></i><i class="icon-star-black"></i></div>
								<div class="price">$2.11</div>
								<a href="#" class="btn"><i class="icon-market"></i>Add To Cart</a>
							</div>
						</div>
						<div class="prd">
							<div class="prd-img">
								<a href="product.html"><img src="images/product/prd-7.jpg" class="img-responsive" alt=""></a>
							</div>
							<div class="prd-info">
								<h3><a href="product.html">Wet Ones Antibacterial Hand Wipes Citrus Scent Travel Pack</a></h3>
						...
						<div class="prd">
							<div class="prd-img">
								<a href="product.html"><img src="images/product/prd-8.jpg" class="img-responsive" alt=""></a>
							</div>
							<div class="prd-info">
						...
						<div class="prd">
							<div class="prd-img">
								<a href="product.html"><img src="images/product/prd-9.jpg" class="img-responsive" alt=""></a>
							</div>
							<div class="prd-info">
								<h3><a href="product.html">Handmaster Medium Utility Stretch Knit Gloves (93TM)</a></h3>
								<div class="price">$9.99</div>
								<a href="#" class="btn"><i class="icon-market"></i>Add To Cart</a>
							</div>
						</div>
